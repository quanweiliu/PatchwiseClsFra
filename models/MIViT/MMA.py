...
class MMA(nn.Module):
    ...
    def forward(self, img11, img21, img12, img22, img13, img23):
        ...
        x_vit, x_cnn, x1_out, x2_out, x1c_out, x_fuse1, x_fuse2, x_transfusion  = \
            self.encoder(img11, img21, img12, img22, img13, img23, single_FLAG=0)
        # print("x_vit", x_vit.shape, "x_cnn", x_cnn.shape) 64, 64, 64
        ...
        mutual_loss = (self.z1_z2_mutual(x_fuse1, x_fuse2) - \
                       self.xishu1 *self.z_z2_mutual(x_transfusion, x_fuse2) - \
                        self.xishu2*self.z1_z_mutual(x_fuse1, x_transfusion))[0]
