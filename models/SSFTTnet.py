...
class SSFTTnet(nn.Module):
    def __init__(self, in_channels=1, num_classes=7, num_tokens=4, dim=64, depth=1, heads=8, mlp_dim=8, dropout=0.1, emb_dropout=0.1):
    ...
    def forward(self, x, mask=None):
        ...
        x = x.unsqueeze(1)  # remove the channel dimension  (我自己加的，原来是没有的)
        # print(x.shape)
