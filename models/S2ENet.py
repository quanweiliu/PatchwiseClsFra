'''
Re-implementation for paper "S²ENet: Spatial–Spectral Cross-Modal Enhancement Network for Classification of Hyperspectral and LiDAR Data"
The official keras implementation is in 
'''
