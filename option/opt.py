...
def get_args():
    ...
    parser.add_argument('--SD',  nargs='+', default=["PaviaU", "Dioni"], 
                        help='SingleModality data')
    parser.add_argument('--MD',  nargs='+', default=["Houston_2013", "Houston_2018"], 
                        help='MultiModality data')

    # model
    # parser.add_argument('--SSSM',  nargs='+', default=["vit", 'cnn', 'mamba'], 
    #                     help='singlescale singlemodality data')
    # parser.add_argument('--MSSM',  nargs='+', default=[], 
    #                     help='multiscale singlemodality data')
    # parser.add_argument('--SSMM',  nargs='+', default=['MS2CANet', 'S2ENet', 'FusAtNet', 'CrossHL', 'HCTNet'], \
    #                     help='singlescale multimodality data')
    # parser.add_argument('--MSMM',  nargs='+', default=["MIViT", 'DSHFNet'], \
    #                     help='mutlisacle multimodality data')   


    parser.add_argument('--SSISO',  nargs='+', default=["vit", 'cnn', 'mamba'], 
                        help='singlesacle singlemodality input and singleoutput')
    parser.add_argument('--SMISO',  nargs='+', default=['S2ENet', 'FusAtNet', 'CrossHL', 'HCTNet'], 
