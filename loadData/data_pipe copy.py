...
def get_data(args):
    ...
    data, _, data_gt = data_reader.load_data(args.dataset_name, path_data=args.path_data, type_data="Houston")
    data, _, train_gt = data_reader.load_data(args.dataset_name, path_data=args.path_data, type_data="TRLabel")
    data, _, test_gt = data_reader.load_data(args.dataset_name, path_data=args.path_data, type_data="TSLabel")
    ...
    print("after padding data_gt", np.unique(data_gt, return_counts=True))
    print("after padding train_gt", np.unique(train_gt, return_counts=True))
    print("after padding test_gt", np.unique(test_gt, return_counts=True))
